<?php
function genor($te="",$page="",$ciudad="") {
        $a=split(" ",$te." Ç");
        $r="";
        $r1="";
        $r2="";
        for ($i=0;$a[$i]!="Ç";$i++) if (strlen(rtrim($a[$i]))>0) {
		...
		if ($idciudads <> "" && $idciudads <> "0") {
			$r.=" and b.idciudad = a.ciudad and a.ciudad=$idciudads and a.plan!='5'";
		}else{
			$r.=" and b.idciudad = a.ciudad and a.plan!='5'";
		}
	}
        if ($r1<>"") {
            $r1=", (".$r1.") as roc";
		...
		if($page == 0){
			...
			return "select a.idnum, a.horario, a.comentario, a.fecharegistro, a.flash, a.web, a.applet, nombre, a.activo, a.imagen, a.plan, a.casa, a.ciudad, a.nextel, a.croquis, a.latitud, a.longitud, a.domicilio, a.celular, a.swlink, a.linktexto, a.linkinfo, b.ciudad as ciudadz, b.ESTADO as nestado, a.btn1, a.recomendar, a.otrosdatos, a.clasificacion, a.linkbtn10, a.telefonos$r1 from directorio as a, ciudades as b$r$r2";
		}
    }
?>